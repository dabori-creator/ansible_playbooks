...
ansible-playbook -i inventory.ini install-exporters.yml --tags "node_exporter,verify"

# Skip verification
ansible-playbook -i inventory.ini install-exporters.yml --skip-tags verify

# Dry run
ansible-playbook -i inventory.ini install-exporters.yml --check
```
